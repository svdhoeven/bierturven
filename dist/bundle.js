...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UsersView = __webpack_require__(7);
	
	var _UsersView2 = _interopRequireDefault(_UsersView);
	
	var _AddUserView = __webpack_require__(8);
	
	var _AddUserView2 = _interopRequireDefault(_AddUserView);
	
	var _DeleteUserView = __webpack_require__(9);
	
	var _DeleteUserView2 = _interopRequireDefault(_DeleteUserView);
	
	var _Beers = __webpack_require__(10);
	...
	var _Record = __webpack_require__(13);
	
	var _Record2 = _interopRequireDefault(_Record);
	
	var _Beer = __webpack_require__(11);
	
	var _Beer2 = _interopRequireDefault(_Beer);
	
	var _BeerView = __webpack_require__(14);
	
	var _BeerView2 = _interopRequireDefault(_BeerView);
	
	var _BeerLockView = __webpack_require__(15);
	
	var _BeerLockView2 = _interopRequireDefault(_BeerLockView);
	
	var _HistoryView = __webpack_require__(16);
	...
	(function () {
	    ...
	    var init = function init() {
	        ...
	        var beersCollection = new _Beers2.default();
	        var historyCollection = new _History2.default();
	
	        //Create new Views
	        new _BeerView2.default({ el: "#selectBeer", collection: beersCollection });
	        new _UsersView2.default({ el: "#users", collection: usersCollection });
	        new _AddUserView2.default({ el: "#addUser" });
	        new _DeleteUserView2.default({ el: "#deleteUser" });
	        new _BeerLockView2.default({ el: "#lock" });
	        new _HistoryView2.default({ el: "#history", collection: historyCollection });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UsersView = _backbone.View.extend({
	    ...
	    initialize: function initialize() {
	        ...
	        this.templateUsers = _underscore2.default.template(this.$('#template-users').html());
	     ...
	     * @param data
	     */
	    loadUsers: function loadUsers(data) {
	        var _this = this;
	
	        this.collection.fetch({
	            success: function success(collection) {
	                return _this.loadUsersSuccessHandler(collection);
	            },
	            error: function error(collection, response) {
	                return _this.loadUsersErrorHandler(collection, response);
	            }
	        });
	    },
	     ...
	     * @param collection
	     */
	    loadUsersSuccessHandler: function loadUsersSuccessHandler(collection) {
	     ...
	     * @param response
	     */
	    loadUsersErrorHandler: function loadUsersErrorHandler(collection, response) {
	     ...
	     * @param e
	     */
	    addBeerHandler: function addBeerHandler(e) {
	        var parentId = e.target.parentElement.parentElement.id;
	        var amount = $('#' + parentId + ' .addOrSubstractValue').val();
	     ...
	     * @param e
	     */
	    substractBeerHandler: function substractBeerHandler(e) {
	        var parentId = e.target.parentElement.parentElement.id;
	        var amount = $('#' + parentId + ' .addOrSubstractValue').val();
	     ...
	     * @returns {*}
	     */
	    getMultiplier: function getMultiplier() {
	     ...
	     * @param amount
	     */
	    putUser: function putUser(id, amount) {
	        $.ajax({
	            dataType: "json",
	            url: 'php/putUser.php',
	            data: {
	     ...
	     * @param data
	     */
	    defaultCallback: function defaultCallback(data) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @constructor
	 */
	var AddUserView = _backbone.View.extend({
	    //Custom events for this view
	    events: {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @constructor
	 */
	var DeleteUserView = _backbone.View.extend({
	    events: {
	        'submit': 'submitHandler'
	    },
	...
	exports.default = DeleteUserView;
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @constructor
	 */
	var Beers = _backbone.Collection.extend({
	  model: _Beer2.default,
	  url: '/bierturven/beer'
	});
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @constructor
	 */
	var Beer = _backbone.Model.extend({
	    defaults: {
	        type: "SmallA",
	        value: 1
	    },
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @constructor
	 */
	var History = _backbone.Collection.extend({
	  model: _Record2.default,
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @constructor
	 */
	var Record = _backbone.Model.extend({
	    defaults: {
	        userId: 0,
	        date: null,
	        amount: 0,
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @constructor
	 */
	var BeerView = _backbone.View.extend({
	    templateBeers: '',
	    ...
	    initialize: function initialize() {
	        //Set templates to use later on
	        this.templateBeers = _underscore2.default.template(this.$('#template-beer').html());
	     ...
	     * @param data
	     */
	    loadBeers: function loadBeers(data) {
	        var _this = this;
	
	        if ($('#lock').attr('class') != 'locked') {
	            this.collection.fetch({
	                success: function success(collection) {
	                    return _this.loadBeersSuccessHandler(collection);
	                }
	            });
	        }
	    },
	     ...
	     * @param collection
	     */
	    loadBeersSuccessHandler: function loadBeersSuccessHandler(collection) {
	     ...
	     * @param e
	     */
	    changeBeer: function changeBeer(e) {
	        var target = e.target;
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @constructor
	 */
	var BeerLockView = _backbone.View.extend({
	    events: {
	     ...
	     *
	     */
	    lockClickHandler: function lockClickHandler() {
	        $('#lock').toggleClass('locked');
	    }
	});
	
	exports.default = BeerLockView;
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @constructor
	 */
	var HistoryView = _backbone.View.extend({
	    templateHistory: '',
	    ...
	    initialize: function initialize() {
	        //Set templates to use later on
	        this.templateHistory = _underscore2.default.template(this.$('#template-history').html());
	     ...
	     * @param data
	     */
	    loadHistory: function loadHistory(data) {
	        var _this = this;
	
	        console.log('fetching history');
	        this.collection.fetch({
	            success: function success(collection) {
	                return _this.loadHistorySuccessHandler(collection);
	            },
	            error: function error(collection, response) {
	                return _this.loadHistoryErrorHandler(collection, response);
	            }
	        });
	    },
	     ...
	     * @param collection
	     */
	    loadHistorySuccessHandler: function loadHistorySuccessHandler(collection) {
	     ...
	     * @param response
	     */
	    loadHistoryErrorHandler: function loadHistoryErrorHandler(collection, response) {
